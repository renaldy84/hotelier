...
hotel_photo.take_photo_from_camera = function(id,myApp,myView){
    ...
    return new Promise(function(resolve,reject){
        try{
            ...
            function(imageURI){
                myView.router.loadPage("upload_hotel_photo.html?id="+id);
                //on success
                ...
                try{
                    ...
                    function(result){
                        ...
                        myView.router.loadPage("edit_hotel.html?id="+id);
                        resolve(result);
                    }, 
                    function(error){
                        //go to upload photo error page
                        myView.router.loadPage("upload_hotel_photo_failed.html?id="+id);
                        reject(error);
...
hotel_photo.take_photo_from_gallery = function(id,myApp,myView){
