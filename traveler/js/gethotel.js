...
$$('#location').on('click', function () {
    myApp.confirm('Visit your device setting and turn on your location?', 'Turn on location', 
      function () {
        myApp.alert('You clicked Ok button, go to setting');
      },
      function () {
...
$$('.failtopay').on('click', function () {
    myApp.confirm('Transaction cannot complete succesfully.', 'Payment failed', 
      function () {
        myApp.alert('You clicked try again');
      },
      function () {
        myApp.alert('You clicked Cancel button');
      }
